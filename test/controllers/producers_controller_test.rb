...
class ProducersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post producers_url, params: { producer: { address: @producer.address, email: @producer.email, name: @producer.name, phone: @producer.phone } }
    end
  ...
  test "should update producer" do
    patch producer_url(@producer), params: { producer: { address: @producer.address, email: @producer.email, name: @producer.name, phone: @producer.phone } }
